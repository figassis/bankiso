...
<!--Generated by Standards Editor (build:R1.0.41.3) on 2013 Mar 05 13:39:35, ISO 20022 version : 2013-->
<xs:schema xmlns="urn:iso:std:iso:20022:tech:xsd:acmt.007.001.02" xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified" targetNamespace="urn:iso:std:iso:20022:tech:xsd:acmt.007.001.02">
    <xs:element name="Document" type="Document"/>
    <xs:complexType name="AccountContract2">
        <xs:sequence>
    ...
    <xs:complexType name="AccountOpeningRequestV02">
        <xs:sequence>
            <xs:element name="Refs" type="References4"/>
            <xs:element maxOccurs="1" minOccurs="0" name="Fr" type="OrganisationIdentification8"/>
            <xs:element name="Acct" type="CustomerAccount4"/>
            <xs:element maxOccurs="1" minOccurs="0" name="CtrctDts" type="AccountContract2"/>
            ...
            <xs:element name="Org" type="Organisation12"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="Mndt" type="OperationMandate2"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="Grp" type="Group1"/>
            <xs:element maxOccurs="1" minOccurs="0" name="RefAcct" type="CashAccount24"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="DgtlSgntr" type="PartyAndSignature2"/>
    ...
    <xs:complexType name="CustomerAccount4">
        <xs:sequence>
    ...
    <xs:complexType name="Document">
        <xs:sequence>
            <xs:element name="AcctOpngReq" type="AccountOpeningRequestV02"/>
        </xs:sequence>
    </xs:complexType>
    ...
    <xs:complexType name="Group1">
        <xs:sequence>
            ...
            <xs:element maxOccurs="unbounded" minOccurs="1" name="Pty" type="PartyAndCertificate2"/>
        </xs:sequence>
    </xs:complexType>
    ...
    <xs:complexType name="OperationMandate2">
        <xs:sequence>
            <xs:element name="Id" type="Max35Text"/>
            ...
            <xs:element maxOccurs="unbounded" minOccurs="0" name="MndtHldr" type="PartyAndAuthorisation1"/>
    ...
    <xs:complexType name="Organisation12">
        <xs:sequence>
            ...
            <xs:element maxOccurs="1" minOccurs="0" name="OprlAdr" type="PostalAddress6"/>
            <xs:element maxOccurs="1" minOccurs="0" name="BizAdr" type="PostalAddress6"/>
            <xs:element name="LglAdr" type="PostalAddress6"/>
            <xs:element maxOccurs="1" minOccurs="0" name="BllgAdr" type="PostalAddress6"/>
            <xs:element name="OrgId" type="OrganisationIdentification8"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="RprtvOffcr" type="PartyIdentification40"/>
            <xs:element maxOccurs="1" minOccurs="0" name="TrsrMgr" type="PartyIdentification40"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="MainMndtHldr" type="PartyIdentification40"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="Sndr" type="PartyIdentification40"/>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="LglRprtv" type="PartyIdentification40"/>
        </xs:sequence>
    </xs:complexType>
    ...
    <xs:complexType name="PartyAndAuthorisation1">
        <xs:sequence>
            <xs:element name="PtyOrGrp" type="PartyOrGroup1Choice"/>
    ...
    <xs:complexType name="PartyAndCertificate2">
        <xs:sequence>
            <xs:element name="Pty" type="PartyIdentification43"/>
            <xs:element maxOccurs="1" minOccurs="0" name="Cert" type="Max10KBinary"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="PartyAndSignature2">
        <xs:sequence>
            <xs:element name="Pty" type="PartyIdentification43"/>
            <xs:element name="Sgntr" type="ProprietaryData3"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="PartyIdentification40">
        <xs:sequence>
            <xs:element maxOccurs="1" minOccurs="0" name="Nm" type="Max140Text"/>
            <xs:element maxOccurs="1" minOccurs="0" name="PstlAdr" type="PostalAddress6"/>
            <xs:element maxOccurs="1" minOccurs="0" name="Id" type="PersonIdentification5"/>
    ...
    <xs:complexType name="PartyOrGroup1Choice">
        <xs:choice>
            <xs:element name="GrpId" type="Max4AlphaNumericText"/>
            <xs:element name="Pty" type="PartyAndCertificate2"/>
        </xs:choice>
    </xs:complexType>
